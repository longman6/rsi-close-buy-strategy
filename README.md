...
## 📈 최종 전략 최적화 보고서 (2026.01.19 업데이트)

> [!IMPORTANT]
> **KOSDAQ 150 RSI 전략 종합 분석 결과**
> 
> RSI 윈도우 3부터 7까지 전수 조사를 통해 최적의 파라미터를 도출했습니다.
> 특히 **RSI 4** 구간에서 수익과 안정성의 완벽한 조화를 발견했습니다.

### 🏅 권장 전략 요약

| 전략 유형 | RSI | 설정 (SMA/Buy/Sell/Hold/Pos) | 15년 수익률 | MDD |
|:---:|:---:|:---|---:|---:|
| 🔥 **수익 극대화** | 3 | SMA 70 / Buy 26 / Sell 72 / Hold 15 / Pos 3 | **5,777%** | -53.4% |
| ⚖️ **최적 밸런스** | **4** | SMA 130 / Buy 32 / Sell 78 / Hold 30 / **Pos 7** | **1,955%** | **-37.4%** |
| 🛡️ **안정형** | 5 | SMA 110 / Buy 20 / Sell 80 / Hold 15 / Pos 3 | **1,574%** | -38.9% |

👉 **[📊 전체 종합 보고서 보기](reports/kosdaq150_rsi_comprehensive_report.md)**

### 관련 분석 보고서
- [RSI 3 상세 결과](reports/rsi_optimization_report.md) \| [RSI 4 상세 결과](reports/rsi4_optimization_report.md) \| [RSI 5 상세 결과](reports/rsi5_optimization_report.md)
- [RSI 6 상세 결과](reports/rsi6_optimization_report.md) \| [RSI 7 상세 결과](reports/rsi7_optimization_report.md)
