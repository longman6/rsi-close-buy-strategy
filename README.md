...
> [!IMPORTANT]
> **KOSDAQ 150 RSI 전략 종합 분석 결과** (2026-01-17)
> 
> 46,000개 이상의 파라미터 조합에 대해 15년간(2010~2025) 백테스트를 수행한 최종 분석 결과입니다.

### 🏅 권장 전략 요약

| 전략 유형 | RSI | 설정 | 15년 수익률 | MDD |
|:---:|:---:|:---|---:|---:|
| 🔥 **공격형** | 3 | SMA 50 / Buy 20 / Sell 80 / Hold 10일 / Pos 3 | **17,385%** | -55.89% |
| ⚖️ **밸런스형 (권장)** | 5 | SMA 30 / Buy 20 / Sell 75 / Hold 30일 / Pos 5 | **3,938%** | -38.82% |
| 🛡️ **안정형** | 5 | SMA 30 / Buy 20 / Sell 70 / Hold 25일 / Pos 3 | **3,629%** | -36.94% |

👉 **[📊 전체 종합 보고서 보기](reports/kosdaq150_rsi_comprehensive_report.md)**

### 관련 분석 보고서

- [RSI 3 최적화 결과](reports/rsi3_optimization_report.md)
- [RSI 5 최적화 결과](reports/rsi5_optimization_report.md)
- [RSI 3 vs 5 비교 분석](reports/rsi_comparison_report.md)
- [Dense Grid Search 결과](reports/rsi_dense_report.md)
- [연도별 성과 비교](reports/yearly_options_comparison.md)
