...
echo "🚀 Starting Full RSI Optimization Sequence..."
echo "---------------------------------------------"

# 1. Optimize RSI 3
echo "👉 Running RSI 3 Optimization..."
"$VENV_PYTHON" "$PROJECT_ROOT/scripts/optimize_rsi3.py"
if [ $? -eq 0 ]; then
    echo "✅ RSI 3 Optimization Completed."
else
    echo "❌ RSI 3 Optimization Failed."
    exit 1
fi
